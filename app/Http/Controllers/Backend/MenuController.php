...
class MenuController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$menu = array(); $menu_bn = array(); $parent_id = array(); $menu_position = array(); $icon = array(); $icon_color = array(); $url = array(); $order = array(); $route = array(); $status = array();
	...
	public function delete($id)
	{
		...
		foreach($allMenus as $menu_key => $allMenu){
			...
			if (is_array($menu_arrays) || is_object($menu_arrays)){

...
@section('content')
  ...
  @php
    ...
    $role_unique = \App\Models\Menu::select(['id', 'menu', 'menu_bn', 'icon_color as color'])->where('url', 'like', '%'.'admin/role/assign'.'%')->get()->keyBy('menu')->toArray();
  @endphp
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-md-6"><h2><i class="fa fa-table"></i>&nbsp;{{ __('backend/admin_setting.change_password') }}</h2></div>

    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="toggle-table-column">
          ...
          <a href="#" class="toggle-vis" data-column="1"><b>{{ __('backend/unit.unit') }}</b></a> |
          <a href="#" class="toggle-vis" data-column="2"><b>{{ __('backend/default.status') }}</b></a> |
        ...
        <div class="table-responsive pt-1">
          <table id="datatable" class="table table-bordered table-hover display">
            ...
            <tbody>
              ...
              <tr class="{{ $unit->status == 0 ? 'inactive_':'' }}">
                <td>{{ $loop->index + 1 }}</td>
                <td>
                  <span>
